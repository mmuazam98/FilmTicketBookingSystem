...
def onClickConfirmButton(mainwindow, allSeats, email, username, movie_name):
    ...
    if not selectedSeats:
        ...
        c = conn.cursor()
        c.execute('''INSERT INTO receipt(receiptNum,seats,price,movie) VALUES (?,?,?,?) ''',
                  (receiptNum, seatStr, price, movie_name))
        conn.commit()
        conn.close()
        ...
        messagebox.showinfo('Booking Successfull', 'Check Your Mailbox')
